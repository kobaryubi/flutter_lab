...
import 'package:etag_cache/src/model/product.dart';
...
class ProductsApi {
  ...
  Future<Response<BuiltList<Product>>> productsWithEtagGet({ 
    ...
    final _path = r'/products/with-etag';
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<Product>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Product>>> productsWithoutEtagGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/products/without-etag';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
