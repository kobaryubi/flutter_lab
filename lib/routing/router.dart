...
import 'package:flutter_lab/ui/add_pass_button/widget/add_pass_button_screen.dart';
import 'package:flutter_lab/ui/adjust_deferred_deeplink/widget/adjust_deferred_deeplink_screen.dart';
...
import 'package:flutter_lab/ui/current_route_state/widget/current_route_state_screen.dart';
import 'package:flutter_lab/ui/debug/widget/debug_screen.dart';
...
import 'package:flutter_lab/ui/e2e_counter/widget/e2e_counter_screen.dart';
import 'package:flutter_lab/ui/editable_text_selection/widget/editable_text_selection_screen.dart';
...
import 'package:flutter_lab/ui/firebase_performance/widget/firebase_performance_screen.dart';
...
import 'package:flutter_lab/ui/http_only_cookie/widget/http_only_cookie_screen.dart';
import 'package:flutter_lab/ui/image_processing/widget/image_processing_screen.dart';
...
import 'package:flutter_lab/ui/loading_submit/widget/loading_submit_screen.dart';
...
import 'package:flutter_lab/ui/multi_tap_guard/widget/multi_tap_guard_screen.dart';
...
import 'package:flutter_lab/ui/phone_call/widget/phone_call_screen.dart';
...
import 'package:flutter_lab/ui/refresh_token/widget/refresh_token_login_screen.dart';
import 'package:flutter_lab/ui/refresh_token/widget/refresh_token_login_web_view_screen.dart';
import 'package:flutter_lab/ui/refresh_token/widget/refresh_token_my_page_screen.dart';
import 'package:flutter_lab/ui/revalidating_image/widget/revalidating_image_screen.dart';
...
import 'package:flutter_lab/ui/selectable_region/widget/selectable_region_screen.dart';
import 'package:flutter_lab/ui/selection_area/widget/selection_area_screen.dart';
...
import 'package:flutter_lab/ui/stack_fit/widget/stack_fit_screen.dart';
import 'package:flutter_lab/ui/stream_subscription/widget/stream_subscription_screen.dart';
import 'package:flutter_lab/ui/swipe_tabs/widget/swipe_tabs_screen.dart';
import 'package:flutter_lab/ui/talker_logs/widget/talker_logs_screen.dart';
import 'package:flutter_lab/ui/tar_download/widget/tar_download_screen.dart';
import 'package:flutter_lab/ui/text_scale/widget/text_scale_screen.dart';
...
part 'add_pass_button_route.dart';
...
part 'multi_tap_guard_route.dart';
...
part 'phone_call_route.dart';
part 'pigeon_route.dart';
part 'pop_scope_route.dart';
part 'portal_route.dart';
part 'push_notification_route.dart';
part 'refresh_token_login_route.dart';
part 'refresh_token_login_web_view_route.dart';
part 'refresh_token_my_page_route.dart';
part 'revalidating_image_route.dart';
...
part 'selectable_region_route.dart';
part 'selection_area_route.dart';
...
part 'stack_fit_route.dart';
part 'stream_subscription_route.dart';
part 'swipe_tabs_route.dart';
part 'talker_logs_route.dart';
part 'tar_download_route.dart';
part 'text_scale_route.dart';
