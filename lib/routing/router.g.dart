...
RouteBase get $crashlyticsRoute => GoRouteData.$route(
  path: '/crashlytics',
  name: 'crashlytics',
  factory: $CrashlyticsRoute._fromState,
);

mixin $CrashlyticsRoute on GoRouteData {
  static CrashlyticsRoute _fromState(GoRouterState state) => CrashlyticsRoute();
...
mixin $HorizontalLayoutRoute on GoRouteData {
  static HorizontalLayoutRoute _fromState(GoRouterState state) =>
      HorizontalLayoutRoute();
...
RouteBase get $webViewTabsRoute => GoRouteData.$route(
  path: '/web_view_tabs',
  factory: $WebViewTabsRoute._fromState,
);
