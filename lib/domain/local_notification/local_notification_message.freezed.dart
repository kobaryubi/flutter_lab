...
mixin _$LocalNotificationMessage {
 ...
 int get id; String get title; String get body; LocalNotificationChannel get channel; String? get imageUrl; int? get badge; Map<String, Object?> get data;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocalNotificationMessage&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.body, body) || other.body == body)&&(identical(other.channel, channel) || other.channel == channel)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.badge, badge) || other.badge == badge)&&const DeepCollectionEquality().equals(other.data, data));
}


@override
int get hashCode => Object.hash(runtimeType,id,title,body,channel,imageUrl,badge,const DeepCollectionEquality().hash(data));

@override
String toString() {
  return 'LocalNotificationMessage(id: $id, title: $title, body: $body, channel: $channel, imageUrl: $imageUrl, badge: $badge, data: $data)';
}
...
@useResult
$Res call({
 int id, String title, String body, LocalNotificationChannel channel, String? imageUrl, int? badge, Map<String, Object?> data
});
...
/// Create a copy of LocalNotificationMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? channel = null,Object? imageUrl = freezed,Object? badge = freezed,Object? data = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String body,  LocalNotificationChannel channel,  String? imageUrl,  int? badge,  Map<String, Object?> data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LocalNotificationMessage() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.channel,_that.imageUrl,_that.badge,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String body,  LocalNotificationChannel channel,  String? imageUrl,  int? badge,  Map<String, Object?> data)  $default,) {final _that = this;
switch (_that) {
case _LocalNotificationMessage():
return $default(_that.id,_that.title,_that.body,_that.channel,_that.imageUrl,_that.badge,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String body,  LocalNotificationChannel channel,  String? imageUrl,  int? badge,  Map<String, Object?> data)?  $default,) {final _that = this;
switch (_that) {
case _LocalNotificationMessage() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.channel,_that.imageUrl,_that.badge,_that.data);case _:
  return null;
...
class _LocalNotificationMessage implements LocalNotificationMessage {
  const _LocalNotificationMessage({required this.id, required this.title, required this.body, required this.channel, required this.imageUrl, required this.badge, final  Map<String, Object?> data = const <String, Object?>{}}): _data = data;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LocalNotificationMessage&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.body, body) || other.body == body)&&(identical(other.channel, channel) || other.channel == channel)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.badge, badge) || other.badge == badge)&&const DeepCollectionEquality().equals(other._data, _data));
}


@override
int get hashCode => Object.hash(runtimeType,id,title,body,channel,imageUrl,badge,const DeepCollectionEquality().hash(_data));
...
/// Create a copy of LocalNotificationMessage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? channel = null,Object? imageUrl = freezed,Object? badge = freezed,Object? data = null,}) {
