...
class $AssetsIconsGen {
  ...
  SvgGenImage get arrowBack =>
      const SvgGenImage.vec('assets/icons/arrow_back.svg');

  /// File path: assets/icons/arrow_forward.svg
  SvgGenImage get arrowForward =>
      const SvgGenImage.vec('assets/icons/arrow_forward.svg');
...
class Assets {
  ...
  /// List of all assets
  static List<dynamic> get values => [activities, destinations, user];
}
