...
class PassKitHostApi {
  /// Constructor for [PassKitHostApi].  The [binaryMessenger] named argument is
  ...
  Future<bool> canAddPass(
    String passTypeIdentifier,
    String serialNumber,
  ) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_lab.PassKitHostApi.canAddPass$pigeonVar_messageChannelSuffix';
    ...
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(
      <Object?>[passTypeIdentifier, serialNumber],
    );
