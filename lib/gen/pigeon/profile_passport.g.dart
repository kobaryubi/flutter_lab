...
class ProfilePassportHostApi {
  /// Constructor for [ProfilePassportHostApi].  The [binaryMessenger] named argument is
  ...
  Future<void> startService() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.flutter_lab.ProfilePassportHostApi.startService$pigeonVar_messageChannelSuffix';
