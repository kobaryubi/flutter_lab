// TODO(temporary): ML Kit temporarily disabled. Uncomment to restore.
...
/// Mock text recognition gateway (ML Kit temporarily disabled).
class MlkitTextRecognitionGateway implements TextRecognitionGateway {
  @override
  AsyncResult<String> recognizeText({
    required CameraImage cameraImage,
    required int sensorOrientation,
    required DeviceOrientation deviceOrientation,
  }) async => '(mock: text recognition disabled)'.toSuccess();
