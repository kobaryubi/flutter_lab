...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ErrorHandlingUiState&&(identical(other.message, message) || other.message == message));
}
...
@override
String toString() {
  return 'ErrorHandlingUiState(message: $message)';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( AsyncValue<String>? message)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ErrorHandlingUiState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( AsyncValue<String>? message)  $default,) {final _that = this;
switch (_that) {
case _ErrorHandlingUiState():
return $default(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( AsyncValue<String>? message)?  $default,) {final _that = this;
switch (_that) {
case _ErrorHandlingUiState() when $default != null:
return $default(_that.message);case _:
  return null;
...
class _ErrorHandlingUiState implements ErrorHandlingUiState {
  const _ErrorHandlingUiState({this.message});
  

@override final  AsyncValue<String>? message;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ErrorHandlingUiState&&(identical(other.message, message) || other.message == message));
}
