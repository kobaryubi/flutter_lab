...
class HomeScreen extends StatelessWidget {
  ...
  static final _links = [
    ...
    const AppLink(title: 'logged in home', route: LoggedInHomeTab1Route()),
    ...
    AppLink(title: 'current route state', route: CurrentRouteStateRoute()),
    AppLink(title: 'horizontal layout', route: HorizontalLayoutRoute()),
    AppLink(title: 'stack fit', route: StackFitRoute()),
    AppLink(title: 'nested button', route: NestedButtonRoute()),
    AppLink(title: 'add pass button', route: AddPassButtonRoute()),
    ...
    AppLink(title: 'carousel', route: CarouselRoute()),
    AppLink(title: 'swipe tabs', route: SwipeTabsRoute()),
  ];
