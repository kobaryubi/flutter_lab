...
class ShellDemoTab2Screen extends HookConsumerWidget {
  const ShellDemoTab2Screen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final routeState = useCurrentRouteState();
    final isActive = routeState.matchedLocation == Routes.shellDemoTab2;
    ...
    useEffect(
      () {
        ...
        ref.read(loggerGatewayProvider).debug('Tab 2 activated');
